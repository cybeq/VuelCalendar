...
const vuelCalendarOptions = ref<IVuelCalendarOptions>({
  ...
  theme:'light',
  toolbars:['step-month', 'step-week', 'date-range', 'time-range'],
  // tresHold:25,
  startHour: 0,
  endHour:29,
...
const  events =() => [
  {
    ...
    data: {
      img:w1,
      color:'#986892',
      header:'Main room conference',
      title:'Tools Supplier, IBC Conference',
      description:'Chujabama'
    },
    start: new Date(new Date(new Date().setHours(8, 0))),
    end: new Date(new Date(new Date().setHours(18, 2))),
  },
  {
    id: rand(3),
    label: 'Alan Fabric',
    data: {
      ...
      color:'#898cb5',
      header:'Main room conference',
      title:'Engineer, Atis Group',
      description:'  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi dolorem incidunt laborum quod repudiandae? Amet ducimus esse inventore quibusdam, quod repellat sint! Autem cupiditate deleniti eveniet laboriosam saepe sit ullam.'
    },
  ...
  },
  {
    ...
    data: {
      img:m2,
      color:'#56a36b',
      header:'Technical Inspection for Equipment Status Evaluation',
      title:'Technical Inspector for Equipment Status Evaluatio',
      description:'  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi dolorem incidunt laborum quod repudiandae? Amet ducimus esse inventore quibusdam, quod repellat sint! Autem cupiditate deleniti eveniet laboriosam saepe sit ullam.'
    },
    start: new Date(new Date().setHours(8, 0)),
    end: new Date(new Date().setHours(23, 0)),
  ...
  {
    id: rand(5),
    label: 'Krzysiek Jerzyna',
    data: {
      img:m3,
      color:'#438789',
      title:'CEO, Atis Group',
    },
    start: new Date(new Date().setHours(8, 0)),
    end: new Date(new Date().setHours(23, 0)),
  },
...
function addEvents3() {
  ...
  for (let i = 0; i < 10000; i++) {
    es.push({
      ...
      label: '4a00' + i + rand(i),
      data: {},
      start: new Date(new Date(new Date().setHours(8, 0)).setDate(4)),
      end: new Date(new Date(new Date().setHours(23, 0)).setDate(4)),
    });
  }
  calendarApi.value!.addEvents(es);
}
